...
$GLOBALS['curent_host'] = 'www.businessbook.co.il'; 


$GLOBALS['curent_host_full'] = 'http://www.businessbook.co.il/';
$GLOBALS['curent_host_fullwslahs'] = 'http://www.businessbook.co.il';
define('CURENT_HOST', 'localhost');
define('CURENT_DB', 'localhost9');
