...
$des=pq($bread1a)->text();
 ...
 $bread1='meta[name="description"]';
         $bread1a=$document->find($bread1);
$meta_des=pq($bread1a)->attr("content");

$meta_des= str_replace('Anfloors', "Паркет Групп", $meta_des);  



   $fp = fopen('res/price_des.csv', 'ab');
   fputcsv($fp, array($_POST['param'][0], $price,$des,$meta_des) );
               fclose($fp);
echo "ok";
/*$firephp->fb(array($_POST['param'][0], $price,$des,$meta_des));*/
